...
<head>
    ...
    <!-- Simple line Icon -->
    <link rel="stylesheet" href="indexcss/simple-line-icons.css">
    <!-- Themify Icon -->
    <link rel="stylesheet" href="indexcss/themify-icons.css">
    <!-- Hover Effects -->
    <link rel="stylesheet" href="indexcss/set1.css">
    <!-- Main CSS -->
...
<body>
            ...
            <div class="container-fluid fixed">
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand" href="index.html">StartOwl</a>
                ...
                <span class="icon-menu"></span>
                    ...
                    <span class="icon-arrow-down"></span>
                                    ...
                                    <li><a href="pages-login.php" class="btn btn-outline-light top-btn" ><span class=""></span> Inicia Sesión o Registrate </a></li>
                                    <li class="nav-item active">
                                        <a class="nav-link" href="pages-user-profile.php">Perfil</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="slider-title_box">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-10">
                                <form action="pages-timeline.php" class="form-wrap mt-4">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="styled-heading">
                        <h3>Que necesitas para emprender?</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="featured-place-wrap">
                        <a href="detail.html">
                            ...
                            <div class="featured-title-box">
                                ...
                                <p>Comida </p> <span>• </span>
                                <p> 6 Nuevos </p> <span> • </span>
                                <p><span>1,5MM</span>$</p>
                                <ul>
                                    ...
                                    <li><span class="icon-screen-smartphone"></span>
                                        <p>Crecimiento en Potencia</p>
                                    </li>
                                    <li><span class="icon-link"></span>
                                        <p>Restaurantes en Santiago</p>
                                    </li>

                                </ul>
                                <div class="bottom-icons">
                                    <div class="open-now">Conoce más de este negocio</div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="#" class="btn btn-danger">VER TODO</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="add-listing-wrap">
                        <h2>Miles de Usuarios registrados</h2>
                        <p>Agrega tu idea y consigue colaboracion por parte de tus Partners </p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="#" class="btn btn-danger"><span class="ti-plus"></span> Agregar Idea de Emprendimiento</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        ...
                        <p>Copyright &copy; 2018 StartOwl. All rights reserved | This site is developed with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">developerOneAsociations</a></p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        <ul>
    ...
    <script src="indexjs/popper.min.js"></script>
