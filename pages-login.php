          ...
          <div class="vd_content-section clearfix">
            <div class="vd_login-page">
              <div class="heading clearfix">
                <div class="logo">
                  <a href="index.php"><h2 class="mgbt-xs-5">StartOwl</h2></a>
                </div>
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="col-xs-6 text-right">
                            <div class=""> <a href="pages-forget-password.php">Olvidaste tu contraseña? </a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <!-- Panel Widget -->
              <div class="register-panel text-center font-semibold"> <a href="pages-register.php">CREAR UNA CUENTA<span class="menu-icon"><i class="fa fa-angle-double-right fa-fw"></i></span></a> </div>
            </div>
            <!-- vd_login-page --> 
            ...
            <div class="row">
              <div class=" col-xs-12">
                <div class="copyright text-center">
                  	Copyright &copy;2018 StartOwl. Todos los Derechos reservados. 
                </div>
              </div>
            </div><!-- row -->
        </div><!-- container -->
...
$(document).ready(function() {
        ...
        form_register_2.validate({
            ...
            submitHandler: function (form) {
				...
				setTimeout(function(){window.location.href = "pages-user-profile.php"},2000)	 ; 				
            }
        });	
